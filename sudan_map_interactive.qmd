...
# Updated interactive plot with ggiraph
p2 <- ggplot() +
  ...
  geom_sf_interactive(
    ...
    aes(
      ...
      data_id = GID_1  # Unique ID for interactivity
    ),
    color = "grey10",
    size = .25,
    alpha = .75
  ...
  geom_text_repel(
    ...
    size = 3,
    color = "black",
    min.segment.length = 0   # Ensures all labels have segments if moved
  ) +
